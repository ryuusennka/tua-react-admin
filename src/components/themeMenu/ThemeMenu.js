/*
 * @Author: ryuusennka
 * @Date: 2021-08-28 00:33:56
 * @LastEditors: ryuusennka
 * @LastEditTime: 2021-08-28 03:20:18
 * @FilePath: /tua-react-admin/src/components/themeMenu/ThemeMenu.js
 * @Description:
 */
...
function ThemeMenu() {
  ...
  const closeMenu = () => menu_toggle_ref.current.classList.remove('active');
  /* #endregion */
  ...
  return (
    <div>
      ...
      <div ref={menu_toggle_ref} className="theme-menu">
